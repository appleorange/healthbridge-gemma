...
export interface PlanCard {
  ...
  isCurrentPlan?: boolean // true = represents user's existing coverage
  isPrimaryRecommendation?: boolean // true = AI's top recommended plan
}
...
export interface CostEstimate {
  ...
  assumptions: string[]
  bestFor: string
  isCurrentPlan?: boolean // true = matches profile.currentEmployerPlan
}
...
export interface FlowchartNode {
  ...
  children?: string[]
  primaryPath?: boolean
  profileData?: string // which specific profile fields drove this decision
}
...
export interface TimelineEvent {
  ...
  actionLabel?: string
  actionUrl?: string
  aiSource?: boolean // true = generated by Claude, false/undefined = static
}
