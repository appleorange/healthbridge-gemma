...
export async function POST(req: Request) {
  try {
    ...
    // Return deterministic result immediately. visaEligibilitySummary is generated by
    // /api/eligibility/thinking in the background on the dashboard — no Ollama wait here.
